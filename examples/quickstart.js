import{M as l,m as p,j as d,a as f,C as m,V as k,b as j,P as o}from"./makeScene2D.3d330a69.js";import{c as u}from"./createRef.60699783.js";let s;s!=null||(s=new l("quickstart",!1,{version:0}));s.loadData({version:0});const c=s;let t;t!=null||(t=new l("quickstart",!1,{version:1,seed:2953611296}));t.loadData({version:1,seed:2953611296});const h=t,a=p(function*(i){const n=u();i.add(d(m,{ref:n,x:-300,width:240,height:240,fill:"#e13238"})),yield*f(n().position.x(300,1).to(-300,1),n().fill("#e6a700",1).to("#e13238",1))});a.name="quickstart";a.meta=h;var r;(r=a.onReplaced)!=null||(a.onReplaced=new k(a.config));const e=j({scenes:[a]}),x=()=>e instanceof o?(e.meta=c,e.name="quickstart",e.logger.warn({message:"A project instance was exported instead of a project factory.",remarks:`<p>Use the <code>makeProject()</code> function instead:</p>
