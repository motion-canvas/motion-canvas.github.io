import{M as i,m,j as d,t as w,d as n,e as g,C as j,V as h,b as k,P as r}from"./makeScene2D.20c8ca9e.js";import{c as u}from"./createRef.f9eb3d88.js";let a;a!=null||(a=new i("tweening-color",!1,{version:0}));a.loadData({version:0});const c=a;let o;o!=null||(o=new i("tweening-color",!1,{version:0}));o.loadData({version:0});const x=o,s=m(function*(p){const t=u();p.add(d(j,{ref:t,width:240,height:240,fill:"#e13238"})),yield*w(2,f=>{t().fill(n.exports.Color.lerp(new n.exports.Color("#e13238"),new n.exports.Color("#e6a700"),g(f)))})});s.name="tweening-color";s.meta=x;var l;(l=s.onReplaced)!=null||(s.onReplaced=new h(s.config));const e=k({scenes:[s]}),P=()=>e instanceof r?(e.meta=c,e.name="tweening-color",e.logger.warn({message:"A project instance was exported instead of a project factory.",remarks:`<p>Use the <code>makeProject()</code> function instead:</p>
